...
def test_get_mask_card_number(card_number_1, card_number_2, card_number_short, card_number_long, card_number_empty):
...
def test_get_mask_account(account_number_1, account_number_2, account_number_short, account_number_long, account_number_empty):

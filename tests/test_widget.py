...
def test_mask_account_card_check(account_card_1, account_card_count_1):
...
@pytest.mark.parametrize("some_account, mask_result", [
    ("Maestro 1596837868705199", "Maestro 1596 83** **** 5199"),
    ("Счет 64686473678894779589", "Счет **9589"),
    ("MasterCard 7158300734726758", "MasterCard 7158 30** **** 6758"),
    ("Счет 35383033474447895560", "Счет **5560")])
def test_mask_account_card_diff_types(some_account, mask_result):
    assert mask_account_card(some_account) == mask_result

def test_mask_account_incorrect_data(account_card_short, account_card_long, account_card_count_short, account_card_count_long):
